...
// src/mcp.js was here until MCP was cut for the Claude-Code-only pivot. It was
// left in this list after the file was deleted, so `npm run release` threw
// ENOENT after already writing package.json and stamping src/index.js - a
// half-applied bump with no build and no gates run.
const STAMPED = ["src/index.js"];
